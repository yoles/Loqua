...
1. **Spike WebGPU/WASM** : Whisper + Kokoro + LLM 1-3B dans le navigateur sur machine réaliste. Mesurer latence, RAM, cold start, taille download. → confirme la viabilité du "web local" ou le cantonne à l'Option B cloud.
