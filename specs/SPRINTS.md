...
## Sprint 1 — Fondations (Étape 1) · _rien de visible à l'écran, c'est voulu_ — ✅ FAIT (2026-07-03)
...
## Sprint 2 — MVP : la boucle de correction (Étape 2) · _le produit existe à la fin_ — ✅ FAIT, checkpoint 2.8 validé (2026-07-03)
...
| **5.2 Tap-sur-mot**              | Panneau mot : lecture isolée, mode boucle (N s réglable), vitesse 0,5×/0,75×/1×, IPA + syllabes (PRD §5).                                                                            | Le flux « je bute sur _interesting_ → je boucle dessus » marche. |
